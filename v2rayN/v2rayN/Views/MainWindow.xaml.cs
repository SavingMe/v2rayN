    ...
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                {
                    Thread.Sleep(5000);
                    string ipv6 = GetAndPrintIPv6Addresses();
                    Dictionary<string, string> headers = new Dictionary<string, string>();
                    headers.Add("all", ipv6);
                    var aa = HttpClientHelper.Instance.PutAsync("http://localhost:5005/home/putall", headers);
                }
        ...
        private static string GetAndPrintIPv6Addresses(string netInterfaceName = "ETH0", string perfix = "2409")
        {
